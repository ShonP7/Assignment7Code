...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Interger Minimum Value = " + myMinValue);
		...
		System.out.println("\nShort Minumun Value = " + myMinShortValue);
